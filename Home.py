...
st.markdown("""
Welcome to my Digital Signal Processing (DSP) project! This project is designed to demonstrate various DSP
techniques and applications. Here, you can explore different signal processing methods, visualize signals, and understand how DSP is used in real-world applications.
